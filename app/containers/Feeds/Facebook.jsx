...
class RexFeedFacebook extends Component {
    render() {
        return (
            <form>
                <div className="content-wrapper">
                    <div className="rex-form-group">
                        ...
                        <ul className="radio-common">
                            <li>
                                <input type="radio" name="fbTimelineType" id="fbTimelineUser" defaultChecked />
                                <label htmlFor="fbTimelineUser"><span></span>User</label>
                            </li>
                            <li>
                                <input type="radio" name="fbTimelineType" id="fbTimilineHastag" />
                                <label htmlFor="fbTimilineHastag"><span></span>Hashtag</label>
                            </li>
                            <li>
                                <input type="radio" name="fbTimelineType" id="fbTimelineLocation" />
                                <label htmlFor="fbTimelineLocation"><span></span>Location</label>
                            </li>
                        </ul>
                    </div>

                    <div className="rex-form-group">
                        <span className="input-title">Facebook Id:</span>
                        <input type="text" name="fb_id" placeholder="User name" />
                    </div>

                    <div className="rex-form-group">
                        <span className="input-title">Check posts every:</span>
                        <ReactResponsiveSelect
                          name="fb_post_sync_time"
                          options={[
                            { value: '1', text: '1 Hour' },
                            { value: '2', text: '2 Hour' },
                            { value: '3', text: '3 Hour' },
